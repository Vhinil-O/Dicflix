...
Como el nombre lo indica esta seccion contiene solo el codigo creado para la version 2 del proyecto, es posible que contenga errores lo cuales se buscan reparar en un futuro cercano, esta version tenemos una pagina funcional con la que podamos buscar diferentes titulos, acceder al preview asi como a los sitios de las peliculas, pero aun no se puede ver las peliculas por lo que trabaja solo como un repositorio para ver informacion basica de la pelicula
...
const wireSearch= () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        renderRow(`Resultado para ${movie}`,shows)
    })
}
